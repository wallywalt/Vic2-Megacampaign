...
diplomacy = {
	...
	DISHONORED_CALLALLY_PRESTIGE_PENALTY = -20,
...
ai =
{
	...
	ONE_SIDE_MAX_WARSCORE = 130, -- don't add too many wargoals to one side in a war
	...
	PEACE_TIME_MONTHS = 10, -- months of additional AI stubbornness in a war
