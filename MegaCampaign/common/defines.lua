...
country = {
	...
	NONCORE_TAX_PENALTY = -0.125, -- -5% for each non-core in state
	...
	WRONG_REFORM_MILITANCY_IMPACT = 3,
...
economy = {
	...
	FACTORY_UPGRADE_EMPLOYEE_FACTOR = 0.70, -- determines how close to the employee limit we need to be before "upgrade all" will upgrade/expand a given factory (1 = 100%).
...
military = {
	...
	POP_MIN_SIZE_FOR_REGIMENT = 3000,
	POP_SIZE_PER_REGIMENT = 3000,
	SOLDIER_TO_POP_DAMAGE = 0.5,
...
diplomacy = {
	...
	OTHER_CONTINENT_BONUS_INFLUENCE_PERCENT = -0.50, -- Malus to countries on another continent
	...
	GW_JUSTIFY_CB_BADBOY_IMPACT = 0.5, -- % deduction of infamy cost for justify CB in great war
...
ai =
{
	...
	MIN_FLEETS = 3, -- Minimum amount of main fleets the AI will divide its navy into (does not include specialized fleets such as blockades and naval invasions)
